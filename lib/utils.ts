...
/**
 * Format market cap to readable string with suffix (T/B/M)
 */
...
/**
 * Get date range for the past X days
 */
...
/**
 * Format article object to desired structure
 */
...
/**
 * Get CSS class for change color based on percentage
 */
...
/**
 * Get alert text for price alerts
 */
